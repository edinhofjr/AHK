...
filter:=""
fruits := [
    "Apple", "Banana", "Orange", "Strawberry", "Lemon", "Mango", "Pineapple", "Grapes", "Peach", "Watermelon", "Kiwi", "Cantaloupe", "Blueberries", "Raspberries", "Blackberries", "Cranberries", "Plums", "Apricots", "Pears", "Cherries"
]
...
LBGUI.OnEvent('Change',LBselection)
